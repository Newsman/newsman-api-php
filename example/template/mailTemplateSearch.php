...
$ret = $client->template->mailTemplateSearch(
	...
	$type /* The template id to perform the search by. Can be:
		unsubscribe_confirm - for unsubscribe mail confirmation content
		subscribe_confirm - for subscribe mail confirmation content
